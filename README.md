...
## Lisence
You may redistribute, republish, and mirror all of the COMNETS Lab dataset in any form. However, any use or redistribution of the data must include a citation to our publicatons or the COMNETS Lab dataset.